...
"x86_64-linux-thread-multi-3.12.20" or
	die "Errno architecture (x86_64-linux-thread-multi-3.12.20) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
